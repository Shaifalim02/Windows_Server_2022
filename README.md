...
| 5️⃣   | Active Directory Domain Services Configuration Wizard used to promote a Windows Server 2022 machine to a Domain Controller. Key steps shown include choosing "Add a new forest", setting the domain name (Server.local), defining DSRM password, selecting functional levels, and configuring DNS delegation. | ![Image Alt](https://github.com/Shaifalim02/Windows_Server_2022/blob/1901968221281fbda80fdcb6b62bc24908d4e61c/image%204.png) |
| 6️⃣   | This image captures the final steps before promoting the server to a Domain Controller in Windows Server 2022. It includes setting the NetBIOS name, defining AD DS paths, reviewing all selected options, and performing a prerequisites check. Once validated, the server is ready to complete the AD DS installation—finalizing the domain setup!  | ![Image Alt](https://github.com/Shaifalim02/Windows_Server_2022/blob/1901968221281fbda80fdcb6b62bc24908d4e61c/image%205.png) |
